...
if s % 6:
    ...
    if a1 > 1:
        print(
            f'Петя сделал {a1} журавликов. Сережа сделал {a2} журавликов. Катя сделала {a3}  журавликов')
    else:
        print(
            f'Петя сделал {a1} журавлика. Сережа сделал {a2} журавлика. Катя сделала {a3}  журавликов')
